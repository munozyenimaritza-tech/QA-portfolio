...
Actualmente continúo fortaleciendo mis habilidades en **automatización de pruebas** y buenas prácticas de QA, con el objetivo de crecer profesionalmente en equipos de alto rendimiento y proyectos de impacto global.
...
### 🚗 Urban Routes | QA Engineer (2025)  
- Diseño y ejecución de casos de prueba funcionales y de regresión.  
- Validación de APIs y reglas de negocio utilizando Postman.  
...
- Ejecución de pruebas manuales y automatizadas para validar flujos críticos.  
...
⭐ *Gracias por visitar mi perfil. ¡Siempre abierta a aprender, colaborar y crecer en QA!*  
